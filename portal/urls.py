...
urlpatterns = [
    ...
    #registaion module
    path('registration',views.registration.registration_page,name='registration'),
     path('',views.registration.registrion_redirect,name='registration'),
        #build pass
    ...
    #login 
    path('login',views.Login.login_page,name='login'),
